...
namespace Egent\Setting\Relationships;

use Egent\Setting\Collections\SettingsCollection;
 ...
 * @mixin \Egent\Setting\Models\Setting
 *
...
class MorphManySettings extends MorphMany
{
    ...
    {
        return $settings->keyBy(function (Setting $setting): string {
    ...
    public function getResults(): SettingsCollection
    {
		...
		$collection->owner = $this->getParent();
