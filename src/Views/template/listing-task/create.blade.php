    ...
    <div class="bg-white text-black shadow p-4 mb-4">
        <div class="container mx-auto">
            <div class="md:flex mb-4 pb-4">
                <div class="w-full md:w-3/4 md:flex md:items-center">
                    <div class="text-left">
                        <h3 class="text-xl font-extrabold mb-2">Create a Listing Task</h3>
                    </div>
                </div>
                <div class="w-full md:w-1/4 md:justify-end md:flex md:items-center">
                    <div class="text-center md:text-right">
            ...
            <form method="post" action="{{ route('settings.templates.listing-tasks.store') }}" autocomplete="off">
                @csrf
                <input type="hidden" name="library" value="{{ $library->getKey() }}" />
