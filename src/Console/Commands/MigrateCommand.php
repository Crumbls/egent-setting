...
use Egent\Setting\Migrator\Data;
use Egent\Setting\Migrator\Migrator;
...
class MigrateCommand extends Command
{
     ...
     *
     * @param  \Egent\Setting\Migrator\Migrator  $migrator
     * @param  \Egent\Setting\Migrator\Data  $data
     */
