...
use Egent\Setting\MorphManySettings;
use Egent\Setting\Scopes\AddMetadata;
use Egent\Setting\SettingsCache;
use Egent\Setting\Casts\DynamicCasting;
 ...
 *
 * @property-read \Egent\Setting\Models\Metadata $metadata
 */
class Setting extends Model
{
     ...
     */
    protected $casts = [
        'value'      => DynamicCasting::class,
        'default'    => DynamicCasting::class,
        'is_enabled' => 'boolean',
    ];
    ...
    {
        static::addGlobalScope(new AddMetadata());
    }
     ...
     *
     * @param  \Egent\Setting\Models\Metadata  $metadata
     *
     * @return $this
     */
